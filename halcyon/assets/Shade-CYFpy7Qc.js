import{e as h,P as s,b8 as A}from"./main-BM5PwmOq.js";import{SUN_DIR as u}from"./Geom-BoSyXAtS.js";import"./BufferGeometryUtils-C4YVS9jO.js";const o=A.shade,e=A.rock.strata,H=A.ground.slab,m={uHalSky:{value:new h(s.skyFloor)},uHalBounce:{value:new h(s.groundBounce)},uHalSun:{value:u.clone()},uHalRoomCol:{value:new h(s.roomShade)},uHalLamp:{value:new h(s.lampWarm)},uHalBedWarm:{value:new h(s.rockBedWarm)},uHalBedCool:{value:new h(s.rockBedCool)},uHalRecess:{value:new h(s.rockRecess)}},v=`
